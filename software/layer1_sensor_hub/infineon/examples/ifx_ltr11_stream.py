...
Example:
  python3 software/layer1_sensor_hub/infineon/examples/ifx_ltr11_stream.py --seconds 10
"""
...
def main() -> int:
    ...
    from software.layer1_sensor_hub.infineon import IfxLtr11PresenceProvider, PresenceSource
