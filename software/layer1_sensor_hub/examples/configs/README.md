...
- `run_live_hub.py --config software/layer1_sensor_hub/examples/configs/mmwave_main.cfg`
- `capture_mmwave_json.py --config software/layer1_sensor_hub/examples/configs/mmwave_main.cfg`
...
- JSON file: `--risk-config software/layer1_sensor_hub/examples/configs/risk_concealed_game_prop.json`
