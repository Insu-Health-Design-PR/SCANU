...
Examples:
  ...
  python3 software/layer1_sensor_hub/examples/radar_kill_switch.py --devices /dev/ttyUSB0 /dev/ttyUSB1

  # Try to stop the radar via CLI, then terminate holders
  python3 software/layer1_sensor_hub/examples/radar_kill_switch.py --cli-port /dev/ttyUSB0 --devices /dev/ttyUSB0 /dev/ttyUSB1 --kill

  # Force-kill if they don't exit
  python3 software/layer1_sensor_hub/examples/radar_kill_switch.py --devices /dev/ttyUSB0 /dev/ttyUSB1 --kill --force
"""
