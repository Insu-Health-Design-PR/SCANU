...
Example:
  python3 layer1_sensor_hub/examples/test/test_connection.py
  python3 layer1_sensor_hub/examples/test/test_connection.py --cli-port /dev/ttyUSB0 --data-port /dev/ttyUSB1
  python3 layer1_sensor_hub/examples/test/test_connection.py --skip-mmwave --thermal-device 0
"""
...
# Repo root (``.../SCANU``): file is under ``software/layer1_sensor_hub/examples/test/``.
_repo_root = Path(__file__).resolve().parents[4]
_software_root = _repo_root / "software"
sys.path.insert(0, str(_repo_root))
sys.path.insert(0, str(_software_root))

from layer1_sensor_hub import SerialManager, ThermalCameraSource
...
def test_infineon(uuid: str | None) -> tuple[bool, str]:
    ...
    from software.layer1_sensor_hub.infineon.ifx_cdc_transport import IfxCdcTransport
